...
def HX_analysis(nt,nb,Nt,Ns,Lt,Y,N,header_gap_n,header_gap):
...
def single_HX_analysis(nt,nb,Nt,Ns,Lt,Y,N,HGn=57.5e-3,HG=57.5e-3,fraction=0.5):
    m_c=hydro.hydraulic_c(Lt,Y,nb,N,Ns)  #run cold hydrualics function
    m_h=hydro.hydraulic_h(Lt,nt,Nt,header_gap_n,header_gap)    #run hot hydraulics
    print("m_h:",m_h)
    print("m_c", m_c)
...
def single_HX_analysis_special(nt,nb,Nt,Ns,Lt,Y,N,HGn=53.5-3,HG=50e-3,fraction=0.25):
    m_c=hydro.hydraulic_c(Lt,Y,nb,N,Ns)  #run cold hydrualics function
    m_h=hydro.hydraulic_h(Lt,nt,Nt,header_gap_n,header_gap)    #run hot hydraulics
    print("m_h:",m_h)
    print("m_c", m_c)
...
e_LMTD , Q_LMTD, e_NTU, Q_NTU =single_HX_analysis(13,14,1,1,0.35,0.012,3,0.0535,0)
print("JL_2018:",e_LMTD , Q_LMTD, e_NTU, Q_NTU)
print("JL_2018:19.7%, 14.79kW")


e_LMTD , Q_LMTD, e_NTU, Q_NTU =single_HX_analysis(14,12,2,2,0.21612,0.015,3,0.041,0.023)
print("B_2017:",e_LMTD , Q_LMTD, e_NTU, Q_NTU)
print("B_2017:31.4%, 13.01kW")

e_LMTD , Q_LMTD, e_NTU, Q_NTU =single_HX_analysis(14,12,1,1,0.232,0.014,4,0.054,0)
