...
def HX_analysis(nt,nb,Nt,Ns,Lt,Y,N,year,HGn=57.5e-3,HG=57.5e-3):                        #iterator uses this
...
def single_HX_analysis(nt,nb,Nt,Ns,Lt,Y,N,year,HGn=57.5e-3,HG=57.5e-3):                 #run checks
    m_c=hydro.hydraulic_c(Lt,Y,nb,N,Ns,year)  #run cold hydrualics function
    m_h=hydro.hydraulic_h(Lt,nt,Nt,HGn,HG,year)    #run hot hydraulics
    print("m_h:",m_h)
    print("m_c", m_c)
